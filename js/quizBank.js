...
const quizBank = {
  ...
  intermediate: [
    ...
    { type: "fill", prompt: "She ___ (not watch) TV yesterday.", a: "did not watch" },
    ...
    { type: "fill", prompt: "___ wants to play football?", a: "Who" },
    { type: "fill", prompt: "We ___ (see) that movie last week.", a: "saw" },
    { type: "fill", prompt: "There is ___ (zero) milk in the fridge.", a: "no" },
    ...
    { type: "fill", prompt: "When I was a child, I ___ (play) outside every day.", a: "used to play" },
    { type: "mc", q: "We decided ___ early.", a: "to leave", o: ["leave", "to leave", "leaving"] },
    { type: "fill", prompt: "She said she ___ (be) tired.", a: "was" },
    ...
    { type: "fill", prompt: "I enjoy ___ (watch) movies at night.", a: "watching" },
    ...
    { type: "fill", prompt: "I ___ finish my homework before I can go out.", a: "must" },
    ...
    { type: "fill", prompt: "I can’t believe he ___ (forget) my birthday!", a: "forgot" },
  ...
  advanced: [
    ...
    { type: "fill", prompt: "The letters ___ (send) already.", a: "have been sent" },
    ...
    { type: "fill", prompt: "The cause ___ the accident is still unknown.", a: "of" },
    ...
    { type: "fill", prompt: "They ___ (must / forget) the meeting.", a: "must have forgotten" },
    ...
    { type: "fill", prompt: "“I love traveling.” — “___ do I.”", a: "so" },
    ...
    { type: "fill", prompt: "He ___ (realize) his mistake only after the email was sent.", a: "had realized" },
    ...
    { type: "fill", prompt: "I look forward to ___ (see) you.", a: "seeing" }
  ]
};
