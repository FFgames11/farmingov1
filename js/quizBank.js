...
const quizBank = {
  ...
  intermediate: [
    ...
    { type:"fill", q:"By the time I arrived, they ___ (start).", a:"had started", hint:"Past perfect" },
    ...
    { type:"fill", q:"Yesterday, I ___ (go) to the park.", a:"went", hint:"Past tense of go" },
    { type:"fill", q:"We ___ (play) soccer now.", a:"are playing", hint:"Present continuous" },
    { type:"fill", q:"She ___ (eat) breakfast at 7.", a:"eats", hint:"Simple present (she)" },
    { type:"fill", q:"They ___ (be) at home yesterday.", a:"were", hint:"Past of 'are'" },
    ...
    { type:"fill", q:"I have ___ (finish) my homework already.", a:"finished", hint:"Past participle" },
    ...
    { type:"fill", q:"She said she ___ (be) tired.", a:"was", hint:"Reported speech" },
    ...
    { type:"fill", q:"I will call you when I ___ (arrive).", a:"arrive", hint:"Present simple in time clause" },
  ...
  advanced: [
    ...
    { type:"fill", q:"Had I known earlier, I ___ (tell) you.", a:"would have told", hint:"Third conditional" },
    ...
    { type:"fill", q:"If she ___ (study) harder, she would have passed.", a:"had studied", hint:"Third conditional" },
    ...
    { type:"fill", q:"Seldom ___ we ___ such honesty. (use: do / witness)", a:"do witness", hint:"Inversion" },
    { type:"mc", q:"He refused to resign, ___ the pressure.", a:"regardless of", o:["because of","regardless of","in case"] },
    { type:"fill", q:"She insisted on ___ (receive) a full explanation.", a:"receiving", hint:"Gerund after 'insisted on'" },
